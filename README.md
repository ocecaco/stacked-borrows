...
(head) of the list. That is, in terms of indexing, 0 is the bottom of the stack
`stk`, and `|stk| - 1` is the top of `stk`.

In Coq, however, to conveniently perform induction on stacks, we pick the head
of the list as the top, and the tail of the list as the bottom of the stack.  In
terms of indexing, 0 is thus the top of the stack, and `|stk| - 1` is the
